...
void update_lives(bool firstRun) {
    ...
    for (uint8_t l = 0; l < lives; l++) {
        draw_sprite(tank_15x8, pos, 15, 8, PIXEL_SIZE_GLOBAL, cyan);
...
{
    // Print LIVES
    draw_sprite(letterL_5x5, RIGHT_EDGE-LETTER_WIDTH*15, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterI_5x5, RIGHT_EDGE-LETTER_WIDTH*14, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterV_5x5, RIGHT_EDGE-LETTER_WIDTH*13, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterE_5x5, RIGHT_EDGE-LETTER_WIDTH*12, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterS_5x5, RIGHT_EDGE-LETTER_WIDTH*11, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
...
void init_bunkers()
{
    ...
    for (uint8_t i = 0; i < 4; i++) {
        draw_sprite(bunker_24x18, pos, 24, 18, PIXEL_SIZE_GLOBAL*2, tan);
...
void init_player()
{
    draw_sprite(tank_15x8, PIXEL_SIZE_GLOBAL*(640*460 + 10), 15, 8, PIXEL_SIZE_GLOBAL*2, cyan);
}
...
void init_end_game() 
{
    ...
    // GAME
    draw_sprite(letterG_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*4), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterA_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*5), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterM_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*6), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterE_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*7), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    // OVER
    draw_sprite(letterO_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*9), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterV_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*10), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterE_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*11), 5, 5, PIXEL_SIZE_GLOBAL*6, white);
    draw_sprite(letterR_5x5, PIXEL_SIZE_GLOBAL*(LETTER_WIDTH*12), 5, 5, PIXEL_SIZE_GLOBAL*6, white);

    // ENTER
    draw_sprite(letterE_5x5, LETTER_WIDTH*20 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterN_5x5, LETTER_WIDTH*21 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterT_5x5, LETTER_WIDTH*22 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterE_5x5, LETTER_WIDTH*23 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterR_5x5, LETTER_WIDTH*24 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    // NAME
    draw_sprite(letterN_5x5, LETTER_WIDTH*26 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterA_5x5, LETTER_WIDTH*27 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterM_5x5, LETTER_WIDTH*28 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);
    draw_sprite(letterE_5x5, LETTER_WIDTH*29 + 640*40*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, white);

    // AAA
    draw_sprite(get_sprite_from_digit(char_0), LETTER_WIDTH*24 + 640*80*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, cyan);
    draw_sprite(get_sprite_from_digit(char_1), LETTER_WIDTH*25 + 640*80*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, cyan);
    draw_sprite(get_sprite_from_digit(char_2), LETTER_WIDTH*26 + 640*80*PIXEL_SIZE_GLOBAL, 5, 5, PIXEL_SIZE_GLOBAL*2, cyan);
