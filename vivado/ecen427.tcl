...
# <./ecen427/ecen427.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project ecen427 ecen427 -part xc7z020clg400-1
}

# Set IP repository paths
set_property  ip_repo_paths  digilent_ip [current_project]
...
proc create_hier_cell_Video { parentCell nameHier } {
 ...
 ] [get_bd_intf_pins /Video/axi_dynclk/s00_axi]
...
proc create_hier_cell_User { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_User() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_Audio { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /Audio/audio_codec_ctrl_0/S_AXI]

  # Create instance: audio_intc, and set properties
  set audio_intc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 audio_intc ]
  set_property -dict [ list \
   CONFIG.C_IRQ_CONNECTION {0} \
   CONFIG.C_KIND_OF_INTR {0xFFFFFFFE} \
 ] $audio_intc
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins s_axi1] [get_bd_intf_pins audio_intc/s_axi]
  ...
  connect_bd_net -net audio_codec_ctrl_0_tx_irq [get_bd_pins audio_codec_ctrl_0/tx_irq] [get_bd_pins audio_intc/intr]
  connect_bd_net -net audio_intc_irq [get_bd_pins irq] [get_bd_pins audio_intc/irq]
  connect_bd_net -net clk_in1_1 [get_bd_pins clk_in1] [get_bd_pins audio_codec_ctrl_0/S_AXI_ACLK] [get_bd_pins audio_intc/s_axi_aclk] [get_bd_pins clk_wiz_10MHz/clk_in1]
  connect_bd_net -net clk_wiz_10MHz_clk_out1 [get_bd_pins audio_clk_10MHz] [get_bd_pins clk_wiz_10MHz/clk_out1]
  connect_bd_net -net resetn_1 [get_bd_pins resetn] [get_bd_pins audio_codec_ctrl_0/S_AXI_ARESETN] [get_bd_pins audio_intc/s_axi_aresetn] [get_bd_pins clk_wiz_10MHz/resetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Audio_irq [get_bd_pins Audio/irq] [get_bd_pins Concat_Interrupts/In0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs Audio/audio_codec_ctrl_0/S_AXI/reg0] SEG_audio_codec_ctrl_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x41810000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs Audio/audio_intc/S_AXI/Reg] SEG_audio_intc_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs Video/axi_dynclk/s00_axi/reg0] SEG_axi_dynclk_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs User/btns_gpio/S_AXI/Reg] SEG_btns_gpio_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs Video/hdmi_out_hpd_video/S_AXI/Reg] SEG_hdmi_out_hpd_video_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41240000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs User/leds_gpio/S_AXI/Reg] SEG_leds_gpio_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs User/rgbleds_gpio/S_AXI/Reg] SEG_rgbleds_gpio_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs User/switches_gpio/S_AXI/Reg] SEG_swsleds_gpio_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41800000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs User/user_intc/S_AXI/Reg] SEG_timer_intc_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs Video/vtc_out/ctrl/Reg] SEG_vtc_out_Reg
...
# file copy -force ./ecen427/ecen427.runs/impl_1/system_wrapper.bit ecen427.bit
